...
/***/ function(module, exports, __webpack_require__) {
	...
	var _App = __webpack_require__(/*! ./js/components/App.jsx */ 168);
	
	var _App2 = _interopRequireDefault(_App);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	__webpack_require__(/*! ./stylesheets/base/reset.scss */ 203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Header = __webpack_require__(/*! ./Header.jsx */ 169);
	
	var _Header2 = _interopRequireDefault(_Header);
	
	var _AllTypesVideos = __webpack_require__(/*! ./AllTypesVideos.jsx */ 174);
	
	var _AllTypesVideos2 = _interopRequireDefault(_AllTypesVideos);
	
	var _Footer = __webpack_require__(/*! ./Footer.jsx */ 199);
	
	var _Footer2 = _interopRequireDefault(_Footer);
	
	var _data = __webpack_require__(/*! ../helpers/data */ 202);
	...
	var App = function App() {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_AllTypesVideos2.default, { allTypesVideos: (0, _data.getAllVideos)() }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../../stylesheets/components/header.scss */ 170);
	...
	var Header = function Header() {
	  return _react2.default.createElement(
	    'header',
	    null,
	    _react2.default.createElement('img', { src: 'imgs/header.jpg', alt: 'header img', className: 'header-img' })
	  );
	};
...
/* 170 */
/*!************************************************!*\
  !*** ./src/stylesheets/components/header.scss ***!
  \************************************************/
/***/ function(module, exports) {
...
/* 174 */
/*!**********************************************!*\
  !*** ./src/js/components/AllTypesVideos.jsx ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _PerTypeVideos = __webpack_require__(/*! ./PerTypeVideos.jsx */ 175);
	
	var _PerTypeVideos2 = _interopRequireDefault(_PerTypeVideos);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	__webpack_require__(/*! ../../stylesheets/components/allTypesVideos.scss */ 197);
	
	
	var AllTypesVideos = function AllTypesVideos(_ref) {
	    var allTypesVideos = _ref.allTypesVideos;
	    return _react2.default.createElement(
	        'section',
	        ...
	        _react2.default.createElement(
	            'ul',
	            null,
	            allTypesVideos.map(function (perTypeVideos) {
	                return _react2.default.createElement(_PerTypeVideos2.default, { key: perTypeVideos.videoType, perTypeVideos: perTypeVideos });
	            })
	        )
	    );
	};
	...
	AllTypesVideos.propTypes = {
	    allTypesVideos: _react.PropTypes.array.isRequired
	};
	
	exports.default = AllTypesVideos;

/***/ },
/* 175 */
/*!*********************************************!*\
  !*** ./src/js/components/PerTypeVideos.jsx ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _VideosList = __webpack_require__(/*! ./VideosList.jsx */ 176);
	
	var _VideosList2 = _interopRequireDefault(_VideosList);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	__webpack_require__(/*! ../../stylesheets/components/videoItem.scss */ 187);
	__webpack_require__(/*! ../../stylesheets/components/perTypeVideos.scss */ 191);
	__webpack_require__(/*! ../../stylesheets/utils/colors.scss */ 193);
	__webpack_require__(/*! ../../stylesheets/utils/spaces.scss */ 195);
	
	
	var PerTypeVideos = function PerTypeVideos(_ref) {
	    var perTypeVideos = _ref.perTypeVideos;
	    return _react2.default.createElement(
	        'li',
	        { className: 'per-type-videos' },
	        _react2.default.createElement(
	            'p',
	            { className: 'per-type-videos--title' },
	            _react2.default.createElement('span', { className: 'icon-' + perTypeVideos.videoType + ' vertical-middle' }),
	            _react2.default.createElement(
	                'span',
	                { className: 'per-type-videos--title--type inline-block vertical-middle' },
	                perTypeVideos.videoType
	            )
	        ),
	        _react2.default.createElement(_VideosList2.default, { videosList: perTypeVideos.videos }),
	        _react2.default.createElement(
	            'div',
	            { className: 'add-new-video' },
	            _react2.default.createElement('span', { className: 'icon-add vertical-middle' }),
	            _react2.default.createElement(
	                'span',
	                { className: 'mid-gray vertical-middle inline-block ml5' },
	                'Add more items'
	            )
	        )
	    );
	...
	PerTypeVideos.propTypes = {
	    perTypeVideos: _react.PropTypes.object.isRequired
	};
	exports.default = PerTypeVideos;

/***/ },
/* 176 */
/*!******************************************!*\
  !*** ./src/js/components/VideosList.jsx ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _VideoItem = __webpack_require__(/*! ./VideoItem.jsx */ 177);
	
	var _VideoItem2 = _interopRequireDefault(_VideoItem);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	__webpack_require__(/*! ../../stylesheets/utils/layout.scss */ 178);
	__webpack_require__(/*! ../../stylesheets/components/videosList.scss */ 189);
	
	
	var VideosList = function VideosList(_ref) {
	    var videosList = _ref.videosList;
	    return _react2.default.createElement(
	        'ul',
	        { className: 'videos-list clearfix' },
	...
	VideosList.propTypes = {
	    videosList: _react.PropTypes.array.isRequired
	};
...
/* 177 */
/*!*****************************************!*\
  !*** ./src/js/components/VideoItem.jsx ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../../stylesheets/utils/layout.scss */ 178);
	__webpack_require__(/*! ../../stylesheets/utils/icons.scss */ 180);
	__webpack_require__(/*! ../../stylesheets/components/videoItem.scss */ 187);
	...
	var VideoItem = function VideoItem(_ref) {
	    ...
	    return _react2.default.createElement(
	        'li',
	        { className: 'video-item float-left' },
	        _react2.default.createElement(
	            'a',
	            { href: '#', className: 'video-item--imag-area' },
	            _react2.default.createElement('img', { src: video.imgUrl, alt: video.alt })
	        ),
	        _react2.default.createElement(
	            'sapn',
	            { className: 'video-item--title inline-block full-width' },
	            video.title
	        ),
	        _react2.default.createElement(
	            'span',
	            { className: 'video-item--action clearfix inline-block full-width' },
	            _react2.default.createElement(
	                'span',
	                { className: 'float-left inline-block half-width' },
	                _react2.default.createElement('span', { className: 'icon-gift vertical-middle' }),
	                _react2.default.createElement(
	                    'span',
	                    { className: 'video-item--id vertical-middle' },
	                    video.id,
	                    ' he'
	                )
	            ),
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('span', { className: 'icon-comment vertical-middle' }),
	                _react2.default.createElement(
	                    'span',
	                    { className: 'video-item--comment vertical-middle' },
	                    video.alt
	                )
	            )
	        )
...
/* 178 */
/*!*******************************************!*\
  !*** ./src/stylesheets/utils/layout.scss ***!
  \*******************************************/
/***/ function(module, exports) {
...
/* 180 */
/*!******************************************!*\
  !*** ./src/stylesheets/utils/icons.scss ***!
  \******************************************/
/***/ function(module, exports) {
...
/* 187 */
/*!***************************************************!*\
  !*** ./src/stylesheets/components/videoItem.scss ***!
  \***************************************************/
/***/ function(module, exports) {
...
/* 189 */
/*!****************************************************!*\
  !*** ./src/stylesheets/components/videosList.scss ***!
  \****************************************************/
/***/ function(module, exports) {
...
/* 191 */
/*!*******************************************************!*\
  !*** ./src/stylesheets/components/perTypeVideos.scss ***!
  \*******************************************************/
/***/ function(module, exports) {
...
/* 193 */
/*!*******************************************!*\
  !*** ./src/stylesheets/utils/colors.scss ***!
  \*******************************************/
/***/ function(module, exports) {
...
/* 195 */
/*!*******************************************!*\
  !*** ./src/stylesheets/utils/spaces.scss ***!
  \*******************************************/
/***/ function(module, exports) {
...
/* 197 */
/*!********************************************************!*\
  !*** ./src/stylesheets/components/allTypesVideos.scss ***!
  \********************************************************/
/***/ function(module, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../../stylesheets/components/footer.scss */ 200);
...
/* 200 */
/*!************************************************!*\
  !*** ./src/stylesheets/components/footer.scss ***!
  \************************************************/
/***/ function(module, exports) {
...
/***/ function(module, exports) {
	...
	var getAllVideos = exports.getAllVideos = function getAllVideos() {
	    return [{
	        videoType: 'music',
	        videos: [{ id: 1, imgUrl: 'imgs/music-a.jpg', alt: 'ma', title: 'Title| Big bang big bang' }, { id: 2, imgUrl: 'imgs/music-b.jpg', alt: 'mb', title: 'Title| Big bang big bang' }, { id: 3, imgUrl: 'imgs/music-c.jpg', alt: 'mc', title: 'Title| Big bang big bang' }, { id: 4, imgUrl: 'imgs/music-d.jpg', alt: 'md', title: 'Title| Big bang big bang' }, { id: 5, imgUrl: 'imgs/music-e.jpg', alt: 'me', title: 'Title| Big bang big bang' }, { id: 6, imgUrl: 'imgs/music-f.jpg', alt: 'mf', title: 'Title| Big bang big bang' }]
	    }, {
	        videoType: 'dance',
	        videos: [{ id: 1, imgUrl: 'imgs/dance-a.jpg', alt: 'aaaaa', title: 'Title| Big bang big bang' }, { id: 2, imgUrl: 'imgs/dance-b.jpg', alt: 'bbbbb', title: 'Title| Big bang big bang' }, { id: 3, imgUrl: 'imgs/dance-c.jpg', alt: 'ccccc', title: 'Title| Big bang big bang' }, { id: 4, imgUrl: 'imgs/dance-d.jpg', alt: 'ddddd', title: 'Title| Big bang big bang' }, { id: 5, imgUrl: 'imgs/dance-e.jpg', alt: 'eeeee', title: 'Title| Big bang big bang' }, { id: 6, imgUrl: 'imgs/dance-f.jpg', alt: 'fffff', title: 'Title| Big bang big bang' }]
	    }];
	};
...
/* 203 */
/*!*****************************************!*\
  !*** ./src/stylesheets/base/reset.scss ***!
  \*****************************************/
/***/ function(module, exports) {
